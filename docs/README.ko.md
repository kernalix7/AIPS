...
1. `https://raw.githubusercontent.com/kernalix7/AIPS/main/AI_PROJECT_SETUP.md` 페치
...
1. [`AI_PROJECT_SETUP.md`](../AI_PROJECT_SETUP.md) 편집 — `kernalix7/AIPS` 2회 모두 `{your-user}/{your-repo}`로 변경:
